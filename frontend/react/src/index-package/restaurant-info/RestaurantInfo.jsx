...
function RestaurantInfo(props) {
  ...
  const { imageSource, name, dong, foodType, reviewCount, avgScore } = props.children;
  ...
  return (
    <div className="restaurant-info-wrapper" onMouseDown={saveXloc} onMouseUp={evalXloc}>
      <RestaurantImage image={imageSource} />
  ...
  if (props.image) {
    return (
      <div className="img-section">
        <img
          src={`${API_BASE_URL}/resources/upload/review/${props.image}`}
          alt="원본이미지 주소 문제"
          width="175px"
          height="175px"
        />
